...
function aicTimeline(){
  ...
  return `<div class="aic-feed-head"><div><p class="eyebrow"><span class="coordinate-dot"></span> 每日精选 / ${esc(HOT.checked.replaceAll('-','.'))}</p><p>按时间看每天热点。垂类行业内容单独放在「主题」，精选只保留通用 AI 变化。</p></div><a class="button" href="#/hot">查看热点榜 ${icon('arrow')}</a></div>
